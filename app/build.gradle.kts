...
android {
  ...
  signingConfigs {
    create("release") {
      // CI decodes the KEYSTORE_B64 secret into this exact path (see
      // .github/workflows/android.yml); KEYSTORE_PATH lets a local/manual
      // build point at a different file instead.
...
dependencies {
  ...
  // Uncomment to use Firestore (also requires re-adding the google-services
  // Gradle plugin and a real app/google-services.json — both were removed
  // since WaStatus doesn't use any Firebase product):
